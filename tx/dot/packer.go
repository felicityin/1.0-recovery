...
import (
	...
	"1.0-recovery/tx/dot/polkadot-adapter/address"
...
func (p *dotPackager) GetSignPacket() (string, error) {
	if p.tran == nil {
		return "", errors.New("transaction not found")
	}
	tp, err := p.tran.NewTxPayLoad(GetTransferCode())
	if err != nil {
		return "", err
	}

	return tp.ToBytesString(), nil
}
